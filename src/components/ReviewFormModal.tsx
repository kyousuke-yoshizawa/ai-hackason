...
export default function ReviewFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-wood-900/50 flex items-center justify-center z-50 px-4">
      <div className="ac-card relative w-full max-w-md">
        ...
        {showSuccess ? (
          ...
          <>
            <h2 className="text-lg font-extrabold text-wood-800 mb-4">レビューを書く</h2>
