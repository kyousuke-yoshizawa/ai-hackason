...
- プランのSVGマップ表示：店舗マーカーのホバー/クリックで詳細ポップアップ、商店街・駅・広場・公園の世界観装飾（#124/#125）
...
- 🤖 **AIプラン提案** 🚧: API実装完了。マップ上で店舗にホバー/クリックすると詳細ポップアップ、商店街・駅・広場・公園の世界観装飾で「ことこと町」らしさを演出

操作手順レベルの詳細は [デモ台本](./demo-script.md) を参照（UI実装(#96/#100)完了後に最終化予定）。
